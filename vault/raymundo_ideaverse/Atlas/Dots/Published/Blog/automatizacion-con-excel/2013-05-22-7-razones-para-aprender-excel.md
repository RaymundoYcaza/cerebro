...
Si aún no te has decidido a (http://www.youtube.com/watch?v=phy-h61Xnlg "¿Qué es Excel?"), tal vez estas 7 razones te ayuden a decidirte o, al menos, demostrarte por qué Excel está en casi todas partes.

### #1 Porque es fácil de usar.

Excel puede parecer intimidante al (http://raymundoycaza.com/excel-para-principiantes/ "Excel para principiantes."); pero la realidad es que se trata de un programa intuitivo y fácil de manejar.
...
Generalmente les recomiendo a (http://raymundoycaza.com/acerca-de/ "Acerca de") que, si tienen en mente realizar un sistema completo en cualquier plataforma y están partiendo de cero, entonces primero realicen un prototipo o un "borrador" del sistema en Excel.
